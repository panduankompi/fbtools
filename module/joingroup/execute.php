...
foreach ($target as $groupid) {	
	...
	sleep(1);
	$jsonresult = array('process' => "Selesai Memproses Join Group dengan id".' : '. $groupid . " <img src='data:image/gif;base64,'/>");
	echo json_encode($jsonresult);	
