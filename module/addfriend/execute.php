...
foreach ($target as $userid) {	
	...
	sleep(1);
	$jsonresult = array('process' => "Selesai Memproses Add Friend dengan id".' : '. $userid . " <img src='data:image/gif;base64,'/>");
	echo json_encode($jsonresult);	
